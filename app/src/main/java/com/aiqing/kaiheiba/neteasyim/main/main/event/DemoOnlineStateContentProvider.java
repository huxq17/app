package com.aiqing.kaiheiba.neteasyim.main.main.event;
...
public class DemoOnlineStateContentProvider implements OnlineStateContentProvider {
    ...
    private String getDisplayContent(String account, boolean simple) {
        if (account == null || account.equals(App.getContext())) {
            return "";
        }
        ...
        return OnlineStateEventManager.getOnlineClientContent(App.getContext(), onlineState, simple);
    }
}
